...
SHELL := /bin/bash
.PHONY: all iso iso-netinst iso-offline package sbom clean test test-suggestions help
...
help:
	...
	@echo "  test-suggestions Run package alternative suggestion helper tests"
...
test-suggestions:
	@echo -e "$(GREEN)Running package suggestion tests...$(NC)"
	./tests/suggest-alternatives-test.sh
